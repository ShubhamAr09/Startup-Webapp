...
export default function CreateStartup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (imageUploadError) {
        return setError("Image upload failed. Please check your images.");
      }
    ...
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-8">
        ...
        <div className="flex flex-col flex-1 gap-4">
          <p className="font-semibold text-lg">Investment Type:</p>
          ...
          <p className="text-green-600">
            {submitSuccess ? "Startup Submitted Successfully!!!" : ""}
          </p>
        </div>
      </form>
    </main>
